document.addEventListener("DOMContentLoaded", function(event) { 
	...
	df_timer = 3000; //time wait before change banner
	df_bann = "#gkHeader"; //id default banner
	...
	function dafault_stat(){
		bpage.getAttribute("href").innerHTML = '/app/'+defaulpage;
		title.innerHTML = defaulttit;
		content.innerHTML = defauldesc;
		banner.style.background = 'url('+path+defaultban+') center';
	}
